...
$('document').ready(function () {
    ...
    $('#wish_message').click(function () {
		...
		$('#b3a').attr('id','b33a')
		$('#b4a').attr('id','b44a')
	  $('#b11').animate({top:350, left: 10},500);
		$('#b22').animate({top:350, left: 60},500);
		$('#b33').animate({top:350, left: 110},500);
		$('#b44').animate({top:350, left: 160},500);
		$('#b55').animate({top:350, left: 210},500);
		$('#b66').animate({top:350, left: 260},500);
		$('#b77').animate({top:350, left: 310},500);
	 $('#b11a').animate({top:480, left: 90},500);
		$('#b22a').animate({top:480, left: 140},500);
		$('#b33a').animate({top:480, left: 190},500);
		$('#b44a').animate({top:480, left: 240},500);
